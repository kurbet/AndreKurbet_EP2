...
while continuar  =='sim': #enquanto o jogador digitar sim, outra forca se inicia
        ...
        if variavel not in letras_chutadas: #
            ...
            for i in range(len(sorteio)):
                ...
                #igual a alguma letra da palavra escreva a letra
                    ...
                    pendown()
                    t.write (sorteio[i], font='arial, 14')
            ...
            #escreva que a palavra é inválida
                t1 = Turtle()
                t1.hideturtle()
                t1.write ('letra inválida', font=('arial', 16))
                time.sleep(1.5)
                t1.clear()
            ...
            t2 = Turtle()
            t2.hideturtle()
            t2.write ('letra já inserida', font=('arial', 16))
            time.sleep(1.5)
            t2.clear()
    ...
    if erros>=6: #quando a variavel erros for igual a 6 (boneco for completo)
        ...
        t.setpos(0,0)
        t.pendown()
        t.write ('VOCE MORREU', font=('arial', 16))#escreve que você morreu
        t.penup()
        t.setpos(50,200)
        t.pendown()
    ...
    #for igual ao número de letras, a palavra estará completa
        ...
        t.setpos(0,0)
        t.pendown()
        t.write ('PARABÉNS, VOCÊ GANHOU', font=('arial', 16)) #escreve que você ganhou
        t.penup()
        t.setpos(50,200)
        t.pendown()
